...
npx moltycash gig create "<description>" --price <USDC> [--quantity <n>] --service <service> [--min-followers <n>] [--require-premium] [--min-account-age <days>] [--network <base|solana|tempo|stellar|monad>]
