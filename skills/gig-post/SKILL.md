...
Rewards are automatic for X-authed payers — $moltycash accumulates in your molty smart wallet at a rate determined by how much $moltycash you already hold there. First-ever paid call unlocks a one-time **100,000 $moltycash starter grant**, which lands you at the **25% floor tier** immediately. From there: 25% (100K–500K) → 50% (500K–1M) → 100% (1M+). Pay a brand-new recipient and your rate is multiplied by **2× (discovery booster)** — so a 1M holder gets 200% of the fee back. Claimable once balance hits 1M $moltycash OR $10K USD value. See [PAYMENT.md → $moltycash rewards](https://molty.cash/skills/PAYMENT.md#moltycash-rewards).
